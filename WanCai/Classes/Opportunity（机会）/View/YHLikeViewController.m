//
//  YHLikeViewController.m
//  WanCai
//
//  Created by yh_swjtu on 16/8/10.
...
@interface YHLikeViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation YHLikeViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    static NSString *identifier = @"liked_list";
