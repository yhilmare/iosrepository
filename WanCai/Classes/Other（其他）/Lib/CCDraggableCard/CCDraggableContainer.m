...
- (void)panGestureHandle:(UIPanGestureRecognizer *)gesture {
    ...
    if (gesture.state == UIGestureRecognizerStateChanged) {
        ...
        if (self.delegate && [self.delegate respondsToSelector:@selector(draggableContainer:draggableDirection:widthRatio:heightRatio:didSelectIndex:)]) {
            ...
            [self.delegate draggableContainer:self draggableDirection:self.direction widthRatio:widthRatio heightRatio:heightRatio didSelectIndex:gesture.view.tag];
        }
    }
    ...
    if (!disappear) {
        ...
        [UIView animateWithDuration:0.5f
                         ...
                         animations:^{
                             ...
                             [self.delegate didRemoveFromSuperViewWithTag:(self.tag - 1) withGesture:direction];
                         }];
...
- (void)originalLayout {
    ...
    //  ---------------------------------------------------------
    if (self.delegate && [self.delegate respondsToSelector:@selector(draggableContainer:draggableDirection:widthRatio:heightRatio: didSelectIndex:)]) {
        [self.delegate draggableContainer:self draggableDirection:self.direction widthRatio:0 heightRatio:0 didSelectIndex:self.tag];
